    ...
    1346:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < N; i++){
    ...
    14f8:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    14fb:	e8 3a 2b 00 00       	call   403a <unlink>
...
00002d80 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    exit(1);
    2e7c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3757:	e8 be 08 00 00       	call   401a <kill>
      exit(1);
    375c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
